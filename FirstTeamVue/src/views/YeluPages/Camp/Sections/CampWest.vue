                ...
                <section class="py-3">
                    <div class="row">
                        <div class="col-lg-2 col-md-12 col-12">
                            <CampBackgroundBlogCard :image="dg1" title="中部營區" description="" />
                        </div>
                        ...
                        <div class="col-lg-2 col-sm-6">
                            <CampTransparentBlogCard :image="dg1" title="2023 福壽山農場千櫻園＆武陵農場賞花一日遊" description="" />
                        </div>
                        <div class="col-lg-2 col-sm-6">
                            <CampTransparentBlogCard :image="dg1" title="2023 九份老街＆野柳＆平溪十分一日遊" description="" />
                        </div>
                        <div class="col-lg-2 col-sm-6">
                            <CampTransparentBlogCard :image="dg1" title="2023 台灣桃園｜東眼山國家森林遊樂區" description="" />
                        </div>
                    </div>
                </section>
            </el-main>
