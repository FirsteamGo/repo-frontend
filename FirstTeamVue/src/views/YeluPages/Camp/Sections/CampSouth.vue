                ...
                <section class="py-3">
                    <div class="row">
                        <div class="col-lg-2 col-md-12 col-12">
                            <CampBackgroundBlogCard :image="sukra" title="南部營區" description="" />
                        </div>
                        ...
                        <div class="col-lg-2 col-sm-6">
                            <CampTransparentBlogCard :image="sukra" title="2023 九份老街＆野柳＆平溪十分一日遊" description="" />
                        </div>
                        <div class="col-lg-2 col-sm-6">
                            <CampTransparentBlogCard :image="sukra" title="2023 台灣桃園｜東眼山國家森林遊樂區" description="" />
                        </div>
                    </div>
                </section>
            </el-main>
