        ...
        <section class="py-3">
          <div class="row">
            <div
              ...
              v-for="item in snowAll.snowpeak.Snowpeak"
              :key="item.商品細項id"
            >
              <card2
                class="cards"
                :image="`${snowAll.Images}${item.產品圖片}`"
                :title="item.產品名稱"
                :description="item.單價"
                :content="item.產品說明"
              />
            ...
            <el-dialog
              v-model="snowAll.dialogvision[2]"
              class="dialog"
              title="商品列表"
              width="30%"
              draggable
              ...
              <div class="common-layout">
                <el-container>
                  <el-aside width="50%">
                    <div>
                      <h6 style="color: black; font-weight: bolder">
                        名稱:{{ snowAll.ShopproductsInfo.產品名稱 }}
                      </h6>
                    </div>
                    <div>
                      <label class="form-label"
                        >價錢:{{ snowAll.ShopproductsInfo.單價 }}</label
                      >
                    </div>

                    <div>
                      <label class="form-label">總價:{{ snowAll.ShopproductsInfo.單價*num }}</label>
                    </div>
                    <div>
                      <el-input-number
                        v-model="num"
                  ...
                  <el-main>
                    <div>
                      <img
                        :src="`${snowAll.Images}${snowAll.ShopproductsInfo.產品圖片}`"
                        alt="商品圖片"
