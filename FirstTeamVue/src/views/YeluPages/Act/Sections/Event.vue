                    ...
                    <div>
                        <el-dialog v-model="EventAll.ActEvent.dialogVisible" title="活動詳細資訊" width="50%" draggable>
                            ...
                            <span class="dialog-footer">
                                <div>
                                    <img :src="`${EventAll.MVCimages}${EventAll.ActEvent.活動圖片}`"
                                        style="width: 400px; height: 300px;">
                                </div>
                                <div>
                                    <label class="form-lable">
                                        <h4>活動名稱：<small class="text-muted"> {{ EventAll.ActEvent.活動名稱 }}</small></h4>
                                    </label>

                                </div>
                                <div>
                                    <label class="form-lable">
                                        <h4>活動介紹：<small class="text-muted"> {{ EventAll.ActEvent.活動介紹 }}</small></h4>
                                    </label>

                                </div>
                                <div>
                                    <label class="form-lable"><span class="material-icons">festival
                                        </span>營區名稱 | {{ EventAll.ActEvent.營區名稱 }}</label>
                                </div>
                                <div>
                                    <label class="form-lable"><span class="material-icons">pin_drop
                                        </span>地區 | {{ EventAll.ActEvent.地區 }}</label>
                                </div>
                                <div>
                                    <label class="form-lable"><span class="material-icons">pin_drop
                                        </span>縣市 | {{ EventAll.ActEvent.縣市 }}</label>
                                </div>
                                <div>
                                    <label class="form-lable">活動方式 | {{ EventAll.ActEvent.活動方式 }} </label>
                                </div>
                                <div>
                                    <label class="form-lable">活動種類 | {{ EventAll.ActEvent.活動種類 }} </label>
                                </div>
                                <div>
                                    <label class="form-lable"><span class="material-icons">attach_money</span> TWD <span
                                            class="text-primary">{{ EventAll.ActEvent.門票價格 }}</span> /次</label>
                                </div>
                            </span>
                        </el-dialog>
                    </div>
