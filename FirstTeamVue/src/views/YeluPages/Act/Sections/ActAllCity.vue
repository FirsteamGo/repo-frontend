    ...
    <el-container>
      ...
      <el-main>
        <section class="py-3">
            ...
            <div class="card m-3 col-lg-2 col-sm-6" v-for="item in NewCity">
              <div class="mb-9 mt-2">
                <ActTransparentBlogCard
                  :image="`${CityAll.MVCimages}${item.活動圖片}`"
                  :title="item.活動名稱"
                />
              </div>

              <div
                class="d-flex row align-items-center mb-5 bottom-button-wrapper"
              >
          ...
          <div>
            <el-dialog
              v-model="CityAll.dialogVisibleArr[8]"
              title="活動詳細資訊"
              width="50%"
              draggable
            >
              ...
              <span class="dialog-footer">
                <div>
                  <img
                    :src="`${CityAll.MVCimages}${CityAll.ActDialogAll.活動圖片}`"
                ...
                <div>
                  <label class="form-lable"
                    >活動方式 | {{ CityAll.ActDialogAll.活動方式 }}
                  </label>
                </div>
                <div>
                  <label class="form-lable"
                    >活動種類 | {{ CityAll.ActDialogAll.活動種類 }}
                  </label>
                </div>
                <div>
                  <label class="form-lable"
                ...
                <RouterLink to="/pages/Yelu-pages/Self/stepall/step2/Act">
                  ...
                  >
                    自選行程<span class="material-icons"
