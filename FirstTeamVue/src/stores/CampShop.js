  ...
  const tnfProduct = async () => {
    try {
      ...
      res.data.forEach((tnfDetails) => {
        const TNFdata = new CampProducts(
          tnfDetails.商品細項id,
          tnfDetails.品牌名稱,
          tnfDetails.產品名稱,
          tnfDetails.產品說明,
  ...
  const snowpeakProduct = async () => {
    try {
      ...
      res.data.forEach((snowdetail) => {
        const Snowdata = new CampProducts(
          snowdetail.商品細項id,
          snowdetail.品牌名稱,
          snowdetail.產品名稱,
          snowdetail.產品說明,
  ...
  const sadomainProduct = async () => {
    try {
      ...
      res.data.forEach((sadodetail) => {
        const sadodata = new CampProducts(
          sadodetail.商品細項id,
          sadodetail.品牌名稱,
          sadodetail.產品名稱,
          sadodetail.產品說明,
  ...
  const titanProduct = async () => {
    try {
      ...
      res.data.forEach((titandetail) => {
        const titandata = new CampProducts(
          titandetail.商品細項id,
          titandetail.品牌名稱,
          titandetail.產品名稱,
          titandetail.產品說明,
  ...
  const forestProduct = async () => {
    try {
      ...
      res.data.forEach((forestdetail) => {
        const forestdata = new CampProducts(
          forestdetail.商品細項id,
          forestdetail.品牌名稱,
          forestdetail.產品名稱,
          forestdetail.產品說明,
  ...
  const lifecodeProduct = async () => {
    try {
      ...
      res.data.forEach((lifecodedetail) => {
        const lifecodedata = new CampProducts(
          lifecodedetail.商品細項id,
          lifecodedetail.品牌名稱,
          lifecodedetail.產品名稱,
          lifecodedetail.產品說明,
          lifecodedetail.產品圖片,
  ...
  const polarstarProduct = async () => {
    try {
      ...
      res.data.forEach((polarstardetail) => {
        const polarstardata = new CampProducts(
          polarstardetail.商品細項id,
          polarstardetail.品牌名稱,
          polarstardetail.產品名稱,
          polarstardetail.產品說明,
          polarstardetail.產品圖片,
          polarstardetail.單價,
          polarstardetail.數量,
          polarstardetail.總價
        );
  ...
  const naturehikeProduct = async () => {
    try {
      ...
      res.data.forEach((naturehikedetail) => {
        const naturehikedata = new CampProducts(
          naturehikedetail.商品細項id,
          naturehikedetail.品牌名稱,
          naturehikedetail.產品名稱,
          naturehikedetail.產品說明,
          naturehikedetail.產品圖片,
          naturehikedetail.單價,
          naturehikedetail.數量,
          naturehikedetail.總價
        );
  ...
  const ivecoProduct = async () => {
    try {
      ...
      res.data.forEach((ivecodetail) => {
        const ivecodata = new CampProducts(
          ivecodetail.商品細項id,
          ivecodetail.品牌名稱,
          ivecodetail.產品名稱,
          ivecodetail.產品說明,
  ...
  const adriaProduct = async () => {
    try {
      ...
      res.data.forEach((adriadetail) => {
        const adriadata = new CampProducts(
          adriadetail.商品細項id,
          adriadetail.品牌名稱,
          adriadetail.產品名稱,
          adriadetail.產品說明,
